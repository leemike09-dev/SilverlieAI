              ...
              <View style={s.linkedCard}>
                ...
                {links.as_family.map((l: any) => (
                  <TouchableOpacity key={l.id} style={s.linkedRow}
                    ...
                    <Text style={{ color: C.peach, fontWeight: '700', fontSize: 16 }}>현황 보기 →</Text>
                  </TouchableOpacity>
                ))}
              </View>
            )}
...
const s = StyleSheet.create({
  ...
  headerSub:     { fontSize: 16, color: 'rgba(255,255,255,0.75)' },
  ...
  segTxt:        { fontSize: 17, fontWeight: '600', color: '#BABABA' },
  ...
  desc:          { fontSize: 17, color: C.text, lineHeight: 26, flex: 1 },
  ...
  codeLbl:       { fontSize: 15, color: C.sub, fontWeight: '600', marginBottom: 12 },
  ...
  codeHint:      { fontSize: 15, color: C.sky, fontWeight: '600' },
  genBtn:        { backgroundColor: C.sky, borderRadius: 18, paddingVertical: 18, alignItems: 'center' },
  genBtnTxt:     { fontSize: 19, fontWeight: '700', color: '#fff' },
  ...
  joinBtnTxt:    { fontSize: 19, fontWeight: '700', color: '#fff' },
  msgBox:        { backgroundColor: '#FEE8E8', borderRadius: 14, padding: 14, marginBottom: 16 },
  msgBoxOk:      { backgroundColor: C.sageLt },
  msgTxt:        { fontSize: 16, color: '#E53935', textAlign: 'center', fontWeight: '600' },
  ...
  linkedTitle:   { fontSize: 16, fontWeight: '700', color: C.sub, marginBottom: 12 },
  ...
  linkedName:    { flex: 1, fontSize: 18, fontWeight: '600', color: C.text },
  linkedBadge:   { backgroundColor: C.sageLt, borderRadius: 8, paddingHorizontal: 10, paddingVertical: 4 },
  linkedBadgeTxt:{ fontSize: 14, color: C.sage, fontWeight: '700' },
