...
const s = StyleSheet.create({
  ...
  input:       { backgroundColor: '#fff', borderWidth: 1.5, borderColor: '#e0e8f8', borderRadius: 13, paddingHorizontal: 16, fontSize: 22, height: 68, color: '#1a2a3a' },
  ...
  // 버튼
  mainBtn:     { backgroundColor: '#1a5fbc', borderRadius: 14, height: 68, alignItems: 'center', justifyContent: 'center', marginBottom: 18, shadowColor: '#1a5fbc', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.28, shadowRadius: 8, elevation: 5 },
