...
const s = StyleSheet.create({
  ...
  appSub:      { fontSize: 20, color: 'rgba(255,255,255,0.80)' },
  // 바디
  body:        { padding: 24, paddingTop: 24, gap: 0 },
  // 탭
  tabs:        { flexDirection: 'row', backgroundColor: '#e8ecf5', borderRadius: 14, padding: 3, marginBottom: 24 },
  tab:         { flex: 1, height: 56, alignItems: 'center', justifyContent: 'center', borderRadius: 11 },
  ...
  tabTxt:      { fontSize: 22, fontWeight: '800', color: '#90a4ae' },
  ...
  // 버튼
  mainBtn:     { backgroundColor: '#1a5fbc', borderRadius: 16, height: 68, alignItems: 'center', justifyContent: 'center', marginBottom: 24, shadowColor: '#1a5fbc', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.28, shadowRadius: 8, elevation: 5 },
  mainBtnTxt:  { fontSize: 26, fontWeight: '900', color: '#fff' },
  // 소셜
  divider:     { flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 18 },
  divLine:     { flex: 1, height: 1, backgroundColor: '#dde3ee' },
  divTxt:      { fontSize: 18, color: '#b0bec5' },
  socialRow:   { flexDirection: 'row', gap: 10, marginBottom: 20 },
  socialBtn:   { flex: 1, borderRadius: 12, height: 60, alignItems: 'center', justifyContent: 'center' },
  socialTxt:   { fontSize: 22, fontWeight: '800', color: '#333' },
  // 찾기
