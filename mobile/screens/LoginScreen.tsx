...
const s = StyleSheet.create({
  ...
  label:       { fontSize: 18, fontWeight: '700', color: '#1a5fbc', marginBottom: 8 },
  input:       { backgroundColor: '#fff', borderWidth: 1.5, borderColor: '#e0e8f8', borderRadius: 13, padding: 16, fontSize: 20, height: 60, color: '#1a2a3a' },
  ...
  mainBtnTxt:  { fontSize: 22, fontWeight: '900', color: '#fff' },
  // 소셜
  ...
  socialTxt:   { fontSize: 18, fontWeight: '700', color: '#333' },
  // 찾기
