...
const styles = StyleSheet.create({
  ...
  chartLabel:{ fontSize: 16, color: '#7A90A8', fontWeight: '700', letterSpacing: 1, marginBottom: 14 },
  ...
  barVal:    { fontSize: 16, fontWeight: '700', color: ACCENT },
  barLbl:    { fontSize: 16, color: '#7A90A8' },
  ...
  statL:    { fontSize: 16, color: '#7A90A8' },
  ...
  aiTagTxt: { color: ACCENT, fontSize: 16, fontWeight: '800', letterSpacing: 1 },
  ...
  trendVal:   { fontSize: 16, fontWeight: '700' },
});
