...
const s = StyleSheet.create({
  ...
  headerSummary: { fontSize: 18, color: 'rgba(255,255,255,0.88)', lineHeight: 20 },
  ...
  catChipTxt: { fontSize: 20, fontWeight: '600', color: '#555' },
  scroll: { flex: 1 },
  scrollContent: { padding: 16 },
  sectionTitle: { fontSize: 18, fontWeight: '800', color: '#1a2a3a', marginBottom: 12 },
  tipCard: {
  ...
  tipTitle: { fontSize: 18, fontWeight: '700', color: '#1a2a3a', marginBottom: 4 },
  tipDesc: { fontSize: 20, color: '#555', lineHeight: 28 },
  infoBox: {
    borderRadius: 14, padding: 16, flexDirection: 'row', gap: 10,
    alignItems: 'center', marginTop: 8},
  infoIcon: { fontSize: 24 },
  infoTxt: { flex: 1, fontSize: 20, fontWeight: '600', lineHeight: 28 },
  ...
  homeBtnTxt: { fontSize: 18, fontWeight: '700', color: '#1a5fbc' }});
